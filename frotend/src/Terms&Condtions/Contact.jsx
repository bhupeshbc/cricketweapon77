  ...
  return (
    <Box className={classes.root_contactus}>
      ...
      <div className={classes.contact_Container_contactus}>
        ...
        <Typography variant="body2" className={classes.para_contact}>
          <span className={classes.para2}>7:00-6:00 Sunday-Monday</span>
          <br />
          <span className={classes.para2}>9:00-4:00 Friday</span>
          <br />
          <span className={classes.para2}>Closed Saturday</span>
        </Typography>
